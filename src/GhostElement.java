 ...
 * Copyright (C) 2016-2026 Christian Schrötter <cs@fnx.li>
 *
...
public class GhostElement
{
	...
	public void importGhost(Element xml) throws GhostException
	{
		...
		{
			GhostPattern = Pattern.compile("\030.\042.(?:\010(?<c>.))?(?:\020(?<g>.))?(?:\030(?<s>.))?\042..+?\\\050.\060.(?:\010(?<b>.{1,5})\\\052)?.*?\062.\012.(?<n>.{1,32})\022\016(?<e>.{1,32})\030(?<v>.{1,2})\100.$", Pattern.DOTALL);
		}
